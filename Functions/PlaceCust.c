                       ...
                       || (((PosTableArray(RN,i).x)-1 == absis()) && ((PosTableArray(RN,i).y)-1 == ordinat()))
                        || (((PosTableArray(RN,i).x)+1 == absis()) && ((PosTableArray(RN,i).y)-1 == ordinat()))
                         ...
                         if (TableArray(RN,i).Kapasitas == 2){
                                ...
                                while ((j != Tail(QCustomer)+1) && (!foundCust2)) {
                                ...
                                if (foundCust2){
                                    ...
                                    TableArray(RN,i).IsFull = true;
                                     ...
                                     if (IsStar(C2)){
                                         Kesabaran(C2) = 20;//terdefinisi ulang untuk customer star
                                     } else{
                                         Kesabaran(C2) = 30;//terdefinisi ulang unuk customer biasa
                                     }
                         ...
                         else if(TableArray(RN,i).Kapasitas == 4)
                            {
                                ...
                                if (Jumlah(CMasuk) == 2)
                                {
                                    ...
                                    (TableArray(RN,i).IsFull = true);
                                     ...
                                     if (IsStar(CMasuk)){
                                         Kesabaran(CMasuk) = 20;//terdefinisi ulang. nah, nanti yg dilihat adalah kesabaran costume atau kesabaran meja?
                                     } else{
                                         Kesabaran(CMasuk) = 30;//terdefinisi ulang. nah, nanti yg dilihat adalah kesabaran costume atau kesabaran meja?
                                     }
